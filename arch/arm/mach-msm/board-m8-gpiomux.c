...
#if 0	/* gpio144 in m8 is for NFC_IRQ pin instaed of HSIC_STROBE */
...
static struct msm_gpiomux_config msm_blsp_configs[] __initdata = {
...
#if 0	/* gpio3 is used by NFC_FWDL pin instead of SPI_CLK */
	{
...
#endif
#if 0	/*These 2 pins are used by headset 1wire*/
	{
	...
	/*This pin should be controlled by sensor hub*/
	{
	...
	/*This pin should be controlled by AUD - WCD9320(AUD_WCD_INTR2_OUT) */
	{
...
static struct gpiomux_setting cam_settings[] = {
	...
	{
		.func = GPIOMUX_FUNC_2, /*active 22 - A FUNC1 2MA*/
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_NONE,
	},
	{
		.func = GPIOMUX_FUNC_GPIO, /*active 23 - I(PU) 2MA*/
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_UP,
		.dir = GPIOMUX_IN,
	},
...
static struct msm_gpiomux_config msm_sensor_configs_non_china_sku[] __initdata = {
	{
		.gpio = 117, /* FRONT CAM ID */
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[23], /*I(PU) 2MA*/
			[GPIOMUX_SUSPENDED] = &cam_settings[10], /*O(L) 2MA*/
		},
	},
};
